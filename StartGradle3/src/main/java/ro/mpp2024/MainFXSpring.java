...
public class MainFXSpring extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ro/mpp2024/RepairShopWindow.fxml"));
...
//        ApplicationContext context = new ClassPathXmlApplicationContext("/ro/mpp2024/RepairShopConfig.xml");
